...
import { addSellerProperty } from '../services/operations/SellerAPI';
...
export default function AddProperty() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res =await dispatch(addSellerProperty(formData,token));
      console.log(res)
      setLoading(false);
      if (!res?.status === 201) {
      ...
      setLoading(false);
      toast.error("Error Adding Properties")
    }
  };
