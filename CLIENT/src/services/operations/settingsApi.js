...
export function updateUserDetails({token,firstName, lastName, dateOfBirth, gender, contactNumber}){
    return async(dispatch) => {
        console.log(firstName,lastName,dateOfBirth,gender,contactNumber)
        const toastId = toast.loading("Loading...")
        try{
